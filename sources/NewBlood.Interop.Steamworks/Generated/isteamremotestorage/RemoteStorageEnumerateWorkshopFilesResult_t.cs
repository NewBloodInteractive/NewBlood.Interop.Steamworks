...
public unsafe partial struct RemoteStorageEnumerateWorkshopFilesResult_t
{
    ...
    [NativeTypeName("float[50]")]
    public fixed float m_rgScore[50];
    ...
    public const int k_iCallback = k_iSteamRemoteStorageCallbacks + 19;
