...
public unsafe partial struct RemoteStorageEnumerateUserSubscribedFilesResult_t
{
    ...
    public fixed uint m_rgRTimeSubscribed[50];

    public const int k_iCallback = k_iSteamRemoteStorageCallbacks + 14;
